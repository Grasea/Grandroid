...
public class ImageUtil {
    ...
    public static Bitmap loadBitmapByApache(String url) throws Exception {
        HttpResponse result = ((ApacheMon) new ApacheMon(url).asGet()).sendWithErrorGetHttpResponse();
    ...
    public static Bitmap downloadAndLoadByApache(String url, File f) throws Exception {
        //from web
        Bitmap bitmap = null;
        HttpResponse result = ((ApacheMon) new ApacheMon(url).asGet()).sendWithErrorGetHttpResponse();
        InputStream is = result.getEntity().getContent();
